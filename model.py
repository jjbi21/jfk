...
class CharRNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, model="lstm", n_layers=1, bidirectional = True):
        ...
        num_of_directions = 2 if bidirectional else 1
    ...
    def init_hidden(self, batch_size):
        num_of_directions = 2 if self.bidirectional else 1
        ...
        return Variable(torch.zeros(self.n_layers * num_of_directions, batch_size, self.hidden_size))
